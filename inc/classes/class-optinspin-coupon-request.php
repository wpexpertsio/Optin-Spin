        ...
        <script type="text/javascript" >
            ...
            function optinspin_add_subsriber( name, email) {
               ...
               /* if(!empty(carbon_get_theme_option('optinspin_cookie_expiry'))) {
                    cookie_expiry = <?php echo carbon_get_theme_option('optinspin_cookie_expiry')?>;
                }*/
...
//                        jQuery('.optinspin-right').fadeOut();
    ...
    function optinspin_send_coupon_email( $to, $coupon, $email_temp ) {
        ...
        if( $email_temp == 'win' ) {
            $subject = carbon_get_theme_option('optinspin_email_subject');
            $msg = carbon_get_theme_option('optinspin_email_body');
        } else {
            $subject = carbon_get_theme_option('optinspin_loss_email_subject');
            $msg = carbon_get_theme_option('optinspin_loss_email_body');
        }
