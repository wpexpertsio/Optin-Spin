=== OptinSpin - Gamified Optin Tool for WordPress, WooCommerce & Easy Digital Downloads ===
Contributors: wpexpertsio
Tags: fortune wheel, mailchimp integration, spin 2 win, upsell marketing, Wheel of Fortune, wheelio for woocommerce, woocommerce coupons, woocommerce fortune wheel
...
= Compatible upto WooCommerce 3.0.x =

[**TRY LIVE ON YOUR SITE**](https://optinspin.com/#try-live-on-your-site)
...
[**Click here to get OptinSpin Pro now**](https://codecanyon.net/item/optinspin-fortune-wheel-fully-integrated-with-woocommerce-coupons/20768678)
...
1. Type in the name \"OptinSpin\" in Search Plugins box
2. Find the \"OptinSpin\" Plugin you wish to install.
...
= 2.0 =
- New Feature - Easy to use, step User interface
