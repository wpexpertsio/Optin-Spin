...
//        add_action('wp_footer',array($this,'test_chatchamp') );
    ...
    function optinspin_chatchamp_is_enabled() {
        $is_enabled = optinspin_get_post_meta($_SESSION['wheel_id'],'optinspin_chatchamp_enabled');
        if(!empty($is_enabled))
            return true;
        else
            return false;
    ...
    function optinspin_get_chatchamp_config_ids() {
        $chatchamp_id = optinspin_get_post_meta($_SESSION['wheel_id'],'optinspin_chatchamp_id');
